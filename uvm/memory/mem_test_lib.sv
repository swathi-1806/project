...
class mem_five_wr_three_rd_test extends mem_base_test;
  `uvm_component_utils(mem_five_wr_three_rd_test)
	`NEW_COMP

task run_phase(uvm_phase phase);
	//create and instantiate the seq
	mem_5_wr_3_rd_seq seq_h = mem_5_wr_3_rd_seq::type_id::create("seq_h");
	//raise objection
	phase.raise_objection(this);
	#20;
	//map the seq
